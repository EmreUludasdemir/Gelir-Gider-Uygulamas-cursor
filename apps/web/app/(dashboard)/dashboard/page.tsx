...
export default function DashboardPage() {
  ...
  const { token, user, initialize, isHydrated, logout } = useAuthStore();
  ...
  const {
    ...
    shouldFetch ? ["transactions", filters] : null,
    ([, params]) => fetchTransactions(params)
  );
  const {
    data: summary,
  ...
  } = useSWR<TransactionSuggestion[]>(
    shouldFetch ? ["suggestions"] : null,
    fetchSuggestions
  );
